                            ...
                            <div className="card">
                                <div className="card-body p-4">
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <p><span><input className='me-2' type='checkbox' name='' /></span>
                                            I agree to the
                                            <Link to="./terms" target='_blank'>Terms and Conditions</Link> and
                                            <Link to="./privacy" target='_blank'>Privacy Policy</Link>.</p>
